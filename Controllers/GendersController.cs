    ...
    public class GendersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genders != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Genders'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("GenderId,GenderValue")] Gender gender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GenderId,GenderValue")] Gender gender)
        {
